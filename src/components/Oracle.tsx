              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 sm:space-x-3">
                    ...
                    <button className="inline-flex items-center justify-center bg-green-600 text-white px-3 sm:px-4 py-2 rounded-lg text-sm font-medium hover:bg-green-700 transition-colors text-center">
                      Pass to Compliance
                    </button>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-4">
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 sm:p-4 text-center">
                    <div className="text-2xl sm:text-3xl font-bold text-yellow-600 mb-1">1</div>
                    <div className="text-base sm:text-lg font-semibold text-yellow-600 mb-1">Medium</div>
